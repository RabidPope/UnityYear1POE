...
using System.Runtime.Serialization.Formatters.Binary;
    ...
    class RangedUnit : Unit
    {
        ...
        private enum UnitShape { V, N }
        public RangedUnit(int xPos, int yPos, int faction, bool attacking) : base("Archer", xPos, yPos, 30, 2, 1, 3, faction, Convert.ToChar(Enum.GetName(typeof(UnitShape), faction)), attacking)
        {
